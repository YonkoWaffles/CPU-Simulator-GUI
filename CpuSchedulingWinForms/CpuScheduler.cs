...
namespace CpuSchedulingWinForms
{
    ...
    {
        Algorithms_2 algorithms_2 = new Algorithms_2();
        ...
        //INSERT MY CODE HERER ________________________________

        private void btnEDF_Click(object sender, EventArgs e)
        {
            if (txtProcess.Text != "")
            {
                algorithms_2.EarliestDeadlineFirst(txtProcess.Text);
                int numberOfProcess = Int16.Parse(txtProcess.Text);
                if (numberOfProcess <= 10)
                {
                    this.progressBar1.Increment(4); //cpu progress bar
        ...
        private void btnMLQ_Click(object sender, EventArgs e)
        {
            if (txtProcess.Text != "")
            {
                algorithms_2.MultiLevelQueue(txtProcess.Text);
                int numberOfProcess = Int16.Parse(txtProcess.Text);
                if (numberOfProcess <= 10)
                {
                    this.progressBar1.Increment(4); //cpu progress bar
        ...
        private void button1_Click_2(object sender, EventArgs e) //Deadlock Button
        {
            if (txtProcess.Text != "")
            {
                algorithms_2.BankersAlgorithm(txtProcess.Text);
                int numberOfProcess = Int16.Parse(txtProcess.Text);
                if (numberOfProcess <= 10)
                {
                    this.progressBar1.Increment(4); //cpu progress bar
        ...
        //END OF MY SECTION ___________________________________________  
